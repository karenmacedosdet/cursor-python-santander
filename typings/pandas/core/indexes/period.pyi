...
class PeriodIndex(DatetimeIndexOpsMixin[pd.Period], PeriodIndexFieldOps):
    def __new__(cls, data=..., ordinal=..., freq=..., tz=..., dtype=..., copy: bool = ..., name: Hashable = ..., **fields):
        ...
...
def period_range(start: (str | datetime.datetime | datetime.date | pd.Timestamp | pd.Period | None) = ..., end: (str | datetime.datetime | datetime.date | pd.Timestamp | pd.Period | None) = ..., periods: int | None = ..., freq: str | BaseOffset | None = ..., name: Hashable | None = ...) -> PeriodIndex:
    ...
