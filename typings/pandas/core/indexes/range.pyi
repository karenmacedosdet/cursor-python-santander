...
class RangeIndex(Index[int]):
    def __new__(cls, start: int | RangeIndex | range = ..., stop: int = ..., step: int = ..., dtype=..., copy: bool = ..., name: Hashable = ...):
        ...
    ...
    def union(self, other: list[HashableT] | Index, sort=...) -> Index | Index[int] | RangeIndex:
        ...
    
    @overload
    def __getitem__(self, idx: slice | np_ndarray_anyint | Sequence[int] | Index | MaskType) -> Index:
        ...
