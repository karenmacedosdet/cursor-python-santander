...
from pandas._typing import AlignJoin, Scalar, T, np_ndarray_bool
...
class StringMethods(NoNewAttributesMixin, Generic[T, _T_EXPANDING, _T_BOOL, _T_LIST_STR, _T_INT, _T_BYTES, _T_STR, _T_OBJECT]):
    ...
    @overload
    def cat(self, *, sep: str, na_rep: str | None = ..., join: AlignJoin = ...) -> str:
        ...
    
    @overload
    def cat(self, others: Literal[None] = ..., *, sep: str, na_rep: str | None = ..., join: AlignJoin = ...) -> str:
        ...
    
    @overload
    def cat(self, others: (Series[str] | Index[str] | pd.DataFrame | npt.NDArray[np.str_] | list[str]), sep: str = ..., na_rep: str | None = ..., join: AlignJoin = ...) -> _T_STR:
        ...
    
    @overload
    def split(self, pat: str = ..., *, n: int = ..., expand: Literal[True], regex: bool = ...) -> _T_EXPANDING:
        ...
    
    @overload
    def split(self, pat: str = ..., *, n: int = ..., expand: Literal[False] = ..., regex: bool = ...) -> _T_LIST_STR:
        ...
    
    @overload
    def rsplit(self, pat: str = ..., *, n: int = ..., expand: Literal[True]) -> _T_EXPANDING:
        ...
    
    @overload
    def rsplit(self, pat: str = ..., *, n: int = ..., expand: Literal[False] = ...) -> _T_LIST_STR:
        ...
    ...
    def contains(self, pat: str | re.Pattern[str], case: bool = ..., flags: int = ..., na: Scalar | NaTType | None = ..., regex: bool = ...) -> _T_BOOL:
        ...
    
    def match(self, pat: str, case: bool = ..., flags: int = ..., na: Any = ...) -> _T_BOOL:
        ...
    
    def replace(self, pat: str, repl: str | Callable[[re.Match[str]], str], n: int = ..., case: bool | None = ..., flags: int = ..., regex: bool = ...) -> _T_STR:
        ...
    
    def repeat(self, repeats: int | Sequence[int]) -> _T_STR:
        ...
    
    def pad(self, width: int, side: Literal["left", "right", "both"] = ..., fillchar: str = ...) -> _T_STR:
        ...
    ...
    def slice(self, start: int | None = ..., stop: int | None = ..., step: int | None = ...) -> T:
        ...
    
    def slice_replace(self, start: int | None = ..., stop: int | None = ..., repl: str | None = ...) -> _T_STR:
        ...
    ...
    def wrap(self, width: int, expand_tabs: bool | None = ..., replace_whitespace: bool | None = ..., drop_whitespace: bool | None = ..., break_long_words: bool | None = ..., break_on_hyphens: bool | None = ...) -> _T_STR:
        ...
    ...
    @overload
    def extract(self, pat: str, flags: int = ..., *, expand: Literal[True] = ...) -> pd.DataFrame:
        ...
    ...
    def fullmatch(self, pat: str, case: bool = ..., flags: int = ..., na: Any = ...) -> _T_BOOL:
        ...
