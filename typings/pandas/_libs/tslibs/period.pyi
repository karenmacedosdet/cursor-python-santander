...
_PeriodAddSub: TypeAlias = (Timedelta | datetime.timedelta | np.timedelta64 | np.int64 | int | BaseOffset)
_PeriodFreqHow: TypeAlias = Literal["S", "E", "start", "end",]
_PeriodToTimestampHow: TypeAlias = (_PeriodFreqHow | Literal["Start", "Finish", "Begin", "End", "s", "e", "finish", "begin",])
class PeriodMixin:
    @property
...
class Period(PeriodMixin):
    def __init__(self, value: (Period | str | datetime.datetime | datetime.date | Timestamp | None) = ..., freq: str | BaseOffset | None = ..., ordinal: int | None = ..., year: int | None = ..., month: int | None = ..., quarter: int | None = ..., day: int | None = ..., hour: int | None = ..., minute: int | None = ..., second: int | None = ...) -> None:
        ...
    ...
    @overload
    def __eq__(self, other: PeriodSeries) -> Series[bool]:
        ...
    ...
    @overload
    def __ne__(self, other: PeriodSeries) -> Series[bool]:
        ...
    ...
    @overload
    def __radd__(self, other: _PeriodAddSub) -> Period:
        ...
    ...
    def to_timestamp(self, freq: str | BaseOffset | None = ..., how: _PeriodToTimestampHow = ...) -> Timestamp:
        ...
